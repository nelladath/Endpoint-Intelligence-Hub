...
function Bar([string]$Name,[string]$Label) { $v=Percent $Name;$w=[math]::Max(0,[math]::Min(100,$v));$c=if($v -ge 95){"#22c55e"}elseif($v -ge 80){"#eab308"}else{"#ef4444"};return "<tr><td style='width:190px;padding:9px 12px;color:#cbd5e1;font-size:14px;font-weight:600'>$Label</td><td style='padding:9px 12px'><div style='background:#1e2a37;height:16px;border-radius:6px'><div style='background:$c;height:16px;border-radius:6px;width:$w%'></div></div><div style='color:#94a3b8;font-size:11px;margin-top:4px'>$(Description $Name)</div></td><td style='width:70px;padding:9px 12px;text-align:right;color:#f8fafc;font-size:14px;font-weight:700'>$([math]::Round($v,1))%</td></tr>" }
